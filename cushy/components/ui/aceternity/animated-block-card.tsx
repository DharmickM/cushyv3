...
import { ShieldCheckIcon,IdCardIcon,FingerprintIcon,VerifiedIcon,UserCheckIcon} from "lucide-react";
...
export function CardDemo() {
  return (
    <Card>
      ...
      <CardTitle>Let’s connect your bank account</CardTitle>
      <CardDescription>
    ...
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
        ...
        <Container className="h-12 w-12 circle-2">
          <IdCardIcon className="h-6 w-6 dark:text-white" />
        </Container>
        <Container className="circle-3">
          <UserCheckIcon className="h-8 w-8 dark:text-white" />
        </Container>
